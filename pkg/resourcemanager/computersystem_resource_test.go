...
func TestNewComputerSystemAdvertisesResetAllowableValues(t *testing.T) {
	computerSystem := NewComputerSystem("1", "test-namespace/test-vm",
		"5d307ca9-b3ef-428c-8861-06e72d69f223", "e4686d2c-6e8d-4335-b8fd-81bee22f4815",
		server.RESOURCEPOWERSTATE_OFF).ComputerSystem()
